...
print("Total of loans: ", total_of_loans)
...
print("Average of loans: ", average_loan_amount)
...
# YOUR CODE HERE!
present_value = calculate_present_value(new_loan.get("future_value"), new_loan.get("remaining_months"), 0.20)
...
for index in range(len(loans)):
    if loans[index].get("loan_price") <= 500:
        inexpensive_loans.append(loans[index])
    index + 1

# @TODO: Print the `inexpensive_loans` list
# YOUR CODE HERE!
print("Inexpensive loans list: ")
